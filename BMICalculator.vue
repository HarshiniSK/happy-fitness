       ...
       <div class="headline font-weight-bold ma-2">BMI Calculator</div>
        <v-form ref="form" id="bmi-form">
            <v-row>
                ...
                <v-text-field color="success" label="Weight (in kgs)" placeholder="In kgs" :rules="rules" v-model="weight" required></v-text-field>
            </v-col>
            <v-col cols="4" lg="6" md="6" sm="6" xs="6">
                <v-text-field color="success"  label="Height (in cms)" placeholder="In cms" :rules="rules" v-model="height" required></v-text-field>
            </v-col>
            </v-row>
            <v-row>
            ...
            <v-col v-if="!isLoggedIn" lg="12" md="12" sm="12" xs="12">
                ...
                <v-btn class="success white--text mr-2 text-capitalize">Click here</v-btn>
            </v-col>
            </v-row>
    ...
    export default {
        ...
        data() {
            return{
                ...
                weight: "",
                height: "",
                rules: [v => !!v || "Field Data is required"],
            }
        },
        computed:{
            bmi(){
