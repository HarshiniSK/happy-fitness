...
<v-container>
    ...
    <v-form ref="formbig" class="hidden-sm-and-down">
      <v-row>
        <v-col cols="8"> 
            <v-text-field color="success" label="Email" :rules="emailrules" v-model="emailb" required></v-text-field>
          </v-col>
      </v-row>
      <v-row>
        <v-col cols="5">
    ...
    <v-form ref="formsmall" class="hidden-md-and-up">
      <v-row>
        <v-col cols="11">
            <v-text-field color="success" label="Email" :rules="emailrules" v-model="emails" required></v-text-field>
          </v-col>
      </v-row>
      <v-row>
        <v-col cols="8">   
